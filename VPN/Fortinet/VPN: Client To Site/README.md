...
![Interfaces FortiGate](image/image02.png)
...
![Ruta estática](image/image03.png)
...
![Usuarios VPN](image/image04.png)
...
![Grupo VPN-USERS](image/image05.png)
...
![Detalle túnel IPsec](image/image07.png)
...
![Políticas de firewall](image/image08.png)
...
![FortiClient conectado - cliente 1](image/image09.png)

**Cliente 2 — IP asignada `30.13.67.11`**

![FortiClient conectado - cliente 2](image/image10.png)
...
![IPsec Monitor](image/image06.png)
...
![Ping desde PC1 a clientes VPN](image/image11.png)
...
![Ping cmd hacia 30.13.67.11](image/image12.png)

**Ping hacia `30.13.67.10`**

![Ping cmd hacia 30.13.67.10](image/image13.png)
...
![ipconfig + ping cliente 1](image/image14.png)

**Cliente con IP de túnel `30.13.67.11`**

![ipconfig + ping cliente 2](image/image15.png)

---

## ✅ Evidencia 12 — Traceroute a través del túnel VPN

Se ejecuta `tracert` desde uno de los clientes VPN hacia el otro, confirmando que el tráfico sale directamente por el túnel IPsec (2 saltos: FortiGate `200.13.67.2` → cliente destino), sin pasar por rutas alternas.

**`tracert 30.13.67.11`**

![Tracert hacia 30.13.67.11](image/image16.png)

**`tracert 30.13.67.10`**

![Tracert hacia 30.13.67.10](image/image17.png)
...
| Ruta del tráfico a través del túnel (traceroute) | ✅ 2 saltos vía FortiGate (200.13.67.2) |
