...
![Topología VPN Client to Site](<img width="1040" height="856" alt="image" src="https://github.com/user-attachments/assets/b17dc03a-9213-4281-83e6-86a9ce160a64" />)
...
3. Contact Info: Next (sin llenar nada)
4. Extra Info:

| Campo | Valor |
|---|---|
| User Account Status | Enabled |
| User Group | No activar aquí |

5. Submit

Para agregar un usuario adicional (por ejemplo `vpnuser2`), repetir estos mismos pasos y luego agregarlo como miembro en **User & Authentication > User Groups > VPN-USERS**.
...
**Paso 5 - Review Settings**

Revisar el resumen y dar clic en **Create**.

---

## 6. FortiGate - Ajustar Fase 1 y Fase 2 del Túnel

**VPN > IPsec Tunnels > Client-To-Site > Edit**

### Quitar dependencia de usuario en el túnel (XAUTH)

- Sección **XAUTH** > Edit
- User Group: seleccionar **Inherit from policy**

### Convertir a túnel personalizado

- Clic en **Convert To Custom Tunnel**
...
| Diffie-Hellman Groups | 14 (único marcado) |
...
Guardar con **OK** en cada sección y **OK** final del túnel.

---

## 7. FortiGate - Políticas de Firewall

**Policy & Objects > Firewall Policy > Create New (Túnel -> LAN)**
...
**Policy & Objects > Firewall Policy > Create New (LAN -> Túnel)**
...
**Policy & Objects > Firewall Policy > Create New (LAN -> WAN / Internet)**
...
## 8. FortiGate - Configuración CLI (respaldo si el GUI no aplica los cambios)
...
## 9. FortiClient - Configuración de Conexión VPN
...
| Detección de Par Muerto (DPD) | Habilitado |
...
## 10. Windows10-2 (Host VLAN 20)

Configurar manualmente la IP en el adaptador de red:
