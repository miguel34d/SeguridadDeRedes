...
## Traducción de IP (NAT) verificada por CLI

Sesión activa mostrando el SNAT real: `10.13.67.2:1 -> 8.8.8.8:8 (200.13.67.2:60418)` — la IP privada de la LAN de usuarios se traduce a la IP pública del port1 (WAN) para salir a Internet.

![Sesión NAT en CLI](./images/10-nat-session-cli.png)
