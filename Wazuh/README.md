...
### 7. Dashboard con ambos agentes activos y alertas acumuladas

Vista `Overview` mostrando **Active (2)** — WEB-1 y Windows10-1 conectados — junto con el resumen de severidad de alertas de las últimas 24 horas (1058 medium, 800 low).

![Dashboard con agentes activos](imagenes/07_wazuh_dashboard_overview_inicial.png)
...
### 12. Confirmación de los dos agentes activos en el dashboard

Vista de **Endpoints** listando ambos agentes registrados y comunicándose correctamente con el manager: `Windows10-1` (005, Windows 10 Enterprise) y `WEB-1` (006, Ubuntu 22.04.5 LTS, contenedor Docker) — ambos con estado **Active**.
